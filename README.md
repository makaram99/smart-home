...
**Uder the supervision of the great instructor:**
...
2. Reading Sesnors (Gas & Temperature): This is done using the task (```taskReadSensors(void *pv )```).
...
1. Open the [index.html](docs/index.html) file.
2. Open the [code_documentation.pdf](docs/code_documentation.pdf) file.
